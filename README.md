...
[![NPM version](https://img.shields.io/npm/v/wedding-invitation-rest-server.svg)](https://www.npmjs.com/package/wedding-invitation-rest-server)
[![Dependency Status](https://david-dm.org/javieraviles/wedding-invitation-rest-server.svg)](https://david-dm.org/javieraviles/wedding-invitation-rest-server)
...
AVAILABLE ENDPOINTS DEMO [SWAGGER DOCS DEMO](https://wedding-invitation-rest-server.herokuapp.com/swagger-html)
...
```
git clone --depth=1 https://github.com/javieraviles/wedding-invitation-rest-server.git <project_name>
```
...
### 1.6.0
 ...
 - PRs merged: [47](https://github.com/javieraviles/wedding-invitation-rest-server/pull/47), [48](https://github.com/javieraviles/wedding-invitation-rest-server/pull/48) and [49](https://github.com/javieraviles/wedding-invitation-rest-server/pull/49). Thanks to everybody!

### 1.5.0
 - koa-swagger-decorator -> generate [swagger docs](https://wedding-invitation-rest-server.herokuapp.com/swagger-html) with decorators in the endpoints
 - Split routes into protected and unprotected. Hello world + swagger docs are not proteted by jwt
 - some dependencies have been updated

### 1.4.2
 - Fix -> `npm run watch-server` is now working properly live-reloading changes in the code [Issue 39](https://github.com/javieraviles/wedding-invitation-rest-server/issues/39).
 - Fix -> Logging levels were not correctly mapped. Thanks to @atamano for the PR [Pull Request 35](https://github.com/javieraviles/wedding-invitation-rest-server/pull/35)
